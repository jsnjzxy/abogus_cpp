// 使用 linkedom 替代 jsdom（更轻量）
const { parseHTML } = require("linkedom");
const dom = parseHTML(`<!DOCTYPE html><p>Hello world</p>`);
...
// XMLHttpRequest polyfill（linkedom 不提供）
...
XMLHttpRequest.prototype.send = function(data) { this.readyState = 4; this.status = 200; if(this.onreadystatechange) this.onreadystatechange(); };
    ...
    var e = {
        ...
        4377: function (e, r, t) {
            ...
            (e.exports = function (e, r) {
                ...
                version: "3.29.1",
                mode: n ? "pure" : "global",
                copyright: "?0?8 2014-2023 Denis Pushkarev (zloirock.ru)",
        ...
        9269: function (e, r, t) {
            ...
            e.exports = !n((function () {
                    ...
                    i && !e.toJSON || !r.size && (i || !f) || !r.sort || "http://a/c%20d?a=1&c=3" !== e.href || "3" !== r.get("c") || "a=1" !== String(new URLSearchParams("?a=1")) || !r[o] || "a" !== new URL("https://a@b").username || "b" !== new URLSearchParams(new URLSearchParams("a=b")).get("a") || "xn--e1aybc" !== new URL("http://��֧��").host || "#%D0%B1" !== new URL("http://a#��").hash || "a1c3" !== t || "x" !== new URL("http://x", void 0).host
                }
            ))
        },
        9366: function (e, r, t) {
...
// console.log(data)
if (typeof global !== 'undefined') global.get_a_bogus = get_a_bogus;
